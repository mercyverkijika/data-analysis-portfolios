...
**Evidence:** Total GMV reached R$15.42M against an R$18.0M target, a shortfall of R$2.58M. Customer retention is 2.9%, late delivery is 6.8%, and GMV leakage is R$97.24K. Average Order Value of R$159.8 is broadly in line with the R$160 benchmark, confirming that the commercial problem is not low basket size. It is frequency and retention.
...
#### 2: Customer retention is the largest single commercial risk on the platform
...
#### 2: Freight burden is a material pressure point in the revenue model
...
#### 3: High freight burden and leakage risk tend to overlap in the same categories
...
**Recommended Visual:** Orders-per-customer frequency distribution bar chart where the 1-order bar dominates all others. Pair with a KPI card showing One-Time Customer Share at 97.1% vs the 85% ceiling in red RAG. The chart needs no annotation: the visual pattern is the argument.

---

#### 2: Repeat customers are few in number but commercially disproportionate in GMV contribution
...
#### 3: The strongest return window is the first 30 days. Delayed campaigns will miss the majority of returnable customers
...
#### 4: Customers who leave stronger reviews are measurably more likely to return
...
#### 2: Late delivery on a first order is associated with an 83% lower repeat purchase rate
...
#### 3: Late delivery risk is geographically concentrated in a small number of states
...
#### 2: The top 4.98% of sellers generate 54% of seller GMV, creating concentrated commercial dependency
...
#### 3: High-GMV sellers with weak service performance require priority commercial intervention
...
| Average Order Value | R$159.8 | > R$160 | -R$0.2 vs benchmark | Amber |
